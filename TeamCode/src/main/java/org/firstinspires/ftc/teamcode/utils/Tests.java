...
// Vendored from Pedro Pathing's AutoTune procedures (SolversLib-Quickstart 4d32c95). Don't edit —
// re-copy it when Pedro ships a new one. Registered in Tuning.java.
